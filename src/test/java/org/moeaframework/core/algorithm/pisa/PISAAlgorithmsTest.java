...
public class PISAAlgorithmsTest {
	...
	public void testNSGA2() {
		...
		Settings.PROPERTIES.setString(
				"org.moeaframework.core.algorithm.pisa.algorithms", name);
		Settings.PROPERTIES.setString("org.moeaframework.core.algorithm.pisa." +
				name + ".command", directory + "/" + "nsga2.exe");
		Settings.PROPERTIES.setStringArray("org.moeaframework.core.algorithm.pisa." +
				name + ".parameters", new String[] { "seed", "tournament" });
		Settings.PROPERTIES.setInt("org.moeaframework.core.algorithm.pisa." + name +
		...
		Settings.PROPERTIES.remove(
				"org.moeaframework.core.algorithm.pisa.algorithms");
	}
