...
import org.moeaframework.core.algorithm.jmetal.JMetalAlgorithmAdapter;
...
public class MOEADTest extends AlgorithmTest {
	...
	public void testSelection() {
		org.moeaframework.core.algorithm.MOEAD moead = null;
		
		Problem problem = new MockRealProblem();
		Properties properties = new Properties();
		
		//the default is de+pm
		moead = (org.moeaframework.core.algorithm.MOEAD)AlgorithmFactory.getInstance()
