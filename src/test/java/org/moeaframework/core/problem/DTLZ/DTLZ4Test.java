 ...
 */
package org.moeaframework.core.problem.DTLZ;
...
import org.moeaframework.core.problem.AnalyticalProblem;
...
public class DTLZ4Test extends ProblemTest {
	...
	protected void test(int M) throws Exception {
		jmetal.core.Problem problemA = new jmetal.problems.DTLZ.DTLZ4("Real",
				M + 9, M);
		Problem problemB = new org.moeaframework.core.problem.DTLZ.DTLZ4(M);
	...
	protected void testReferenceSet(int M) {
		AnalyticalProblem problem = new org.moeaframework.core.problem.DTLZ.DTLZ4(M);
