 ...
 * org.moeaframework.core.problem.problems} property, with the class and optional
 * reference set defined by the {@code org.moeaframework.core.problem.NAME.class}
 * and {@code org.moeaframework.core.problem.NAME.referenceSet} properties.
...
public class PropertiesProblems extends ProblemProvider {
	 ...
	 * {@code org.moeaframework.core.problem.problems} property, {@code name} is
	 * returned unchanged.
	 * 
