 ...
 */
package org.moeaframework.core.algorithm;
...
import org.moeaframework.core.algorithm.evolutionary.EpsilonMOEA;
import org.moeaframework.core.algorithm.evolutionary.GDE3;
import org.moeaframework.core.algorithm.evolutionary.IBEA;
import org.moeaframework.core.algorithm.evolutionary.MSOPS;
import org.moeaframework.core.algorithm.evolutionary.NSGAII;
import org.moeaframework.core.algorithm.evolutionary.PAES;
import org.moeaframework.core.algorithm.evolutionary.PESA2;
import org.moeaframework.core.algorithm.evolutionary.RVEA;
...
import org.moeaframework.core.algorithm.evolutionary.SMSEMOA;
import org.moeaframework.core.algorithm.evolutionary.SPEA2;
import org.moeaframework.core.algorithm.evolutionary.VEGA;
import org.moeaframework.core.algorithm.evolutionary.single.DifferentialEvolution;
import org.moeaframework.core.algorithm.evolutionary.single.EvolutionStrategy;
import org.moeaframework.core.algorithm.evolutionary.single.GeneticAlgorithm;
import org.moeaframework.core.algorithm.single.RepeatedSingleObjective;
import org.moeaframework.core.comparator.single.AggregateObjectiveComparator;
import org.moeaframework.core.comparator.single.MinMaxDominanceComparator;
import org.moeaframework.core.comparator.single.LinearDominanceComparator;
import org.moeaframework.core.algorithm.single.SelfAdaptiveNormalVariation;
...
import org.moeaframework.spi.AlgorithmProvider;
import org.moeaframework.spi.OperatorFactory;
import org.moeaframework.spi.ProviderLookupException;
import org.moeaframework.spi.ProviderNotFoundException;
...
public class StandardAlgorithms extends AlgorithmProvider {
	...
	private Algorithm newNSGAIII(TypedProperties properties, Problem problem) {
		...
		if (properties.contains("populationSize")) {
			...
			populationSize = (int)(BinomialCoefficient.value(problem.getNumberOfObjectives() + divisionsOuter - 1, divisionsOuter) +
					(divisionsInner == 0 ? 0 : BinomialCoefficient.value(problem.getNumberOfObjectives() + divisionsInner - 1, divisionsInner)));
	...
	private Algorithm newDBEA(TypedProperties properties, Problem problem) {
		...
		int populationSize = (int)(BinomialCoefficient.value(problem.getNumberOfObjectives() + divisionsOuter - 1, divisionsOuter) +
					(divisionsInner == 0 ? 0 : BinomialCoefficient.value(problem.getNumberOfObjectives() + divisionsInner - 1, divisionsInner)));
